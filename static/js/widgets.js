...
//     var cfg = {
//       widgetUrl: (scriptEl && scriptEl.dataset && scriptEl.dataset.widgetUrl) || 'http://127.0.0.1:8000/',
...
//       if (cfg.position === 'top-right') { iframe.style.top = '20px'; iframe.style.right = '20px'; }
//       else if (cfg.position === 'top-left') { iframe.style.top = '20px'; iframe.style.left = '20px'; }
//       else if (cfg.position === 'bottom-left') { iframe.style.left = '20px'; iframe.style.bottom = '24px'; }
//       else { iframe.style.right = '20px'; iframe.style.bottom = '24px'; }
